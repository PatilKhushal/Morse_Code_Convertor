...
def newRoot1():
    ...
    Label0 = Label(root2, text = "Text 2 Morse-Code Module", bg = 'white', fg = 'blue', font=("Times New Roman bold", 50))
    Label0.grid(row = 0, column = 0, columnspan = 3)

    validateTextLabel = Label(root2, text = "", bg = 'white', fg = 'red', font=("Times New Roman bold", 15))
    validateTextLabel.grid(row = 2, column = 1)

    Label2 = Label(root2, text = "Equivalent Morse Code", bg = 'white', fg = 'green', font=("Times New Roman bold", 20))
    Label2.grid(row = 3, column = 0, sticky = E)

    result = Label(root2, text = "", bg = 'white', width = 42, fg = 'red', font=("Times New Roman bold", 15))
    result.grid(row = 3, column = 1)

    Label1 = Label(root2, text = "Enter Text", bg = 'white', fg = 'green', font=("Times New Roman bold", 20)).grid(row = 1, column = 0, sticky = E)
...
def newRoot2():
    ...
    Label0 = Label(root2, text = "Morse-Code 2 Text Module", bg = 'white', fg = 'blue', font=("Times New Roman bold", 50))
    Label0.grid(row = 0, column = 0, columnspan = 3)

    validateTextLabel = Label(root2, text = "", bg = 'white', fg = 'red', font=("Times New Roman bold", 15))
    validateTextLabel.grid(row = 2, column = 1)

    Label2 = Label(root2, text = "Equivalent Text", bg = 'white', fg = 'green', font=("Times New Roman bold", 20))
    Label2.grid(row = 3, column = 0, sticky = E)

    result = Label(root2, text = "", bg = 'white', width = 42, fg = 'red', font=("Times New Roman bold", 15))
    result.grid(row = 3, column = 1)

    Label1 = Label(root2, text = "Enter Morse Code", bg = 'white', fg = 'green', font=("Times New Roman bold", 20)).grid(row = 1, column = 0, sticky = E)
    text = Entry(root2, font=("Times New Roman bold", 15))
...
Label(root, text = "Morse-Code Translator", bg = 'white', fg = 'blue', font=("Times New Roman bold", 50)).grid(row = 0, column = 0, columnspan = 3)
